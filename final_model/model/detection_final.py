...
df_all_anno = pd.read_csv(f'../merged_annotations/all_annotations_tr_no_category.csv')
df_gpt = pd.read_csv(f'../gpt_predictions/gpt_anno_no_category.csv')
df_full = pd.read_csv(f'../matching_annotations/full_match_no_category.csv')
