...
df_all_anno = pd.read_csv(f'/users/hasan.seker/baseline/all_annotations_no_category.csv')
df_gpt = pd.read_csv(f'/users/hasan.seker/baseline/gpt_anno_no_category.csv')
df_full = pd.read_csv(f'/users/hasan.seker/baseline/full_match_no_category.csv')
...
for dataset in ds.keys():
    ...
    wandb.init(
        project="detection_final",  # Replace with your project name
    ...
    training_args = TrainingArguments(
        output_dir=f"{learn_rate}_{batch_size}_{num_epoch}_detect",
        learning_rate=learn_rate,
